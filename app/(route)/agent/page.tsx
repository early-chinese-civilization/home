            ...
            <div className="max-w-5xl mx-auto px-4 py-16">
                <div className="grid grid-cols-2 gap-12 items-stretch">
                    ...
                    <div className="flex justify-center">
                        <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 rounded-lg p-8 w-full h-full flex flex-col relative overflow-hidden">
                            ...
                            <div className="relative text-center flex-1 flex items-center justify-center">
                                ...
                                <div className="relative w-96 h-96">
                                    {/* Outer ring - 第一层：接口层 */}
                                    <div className="absolute inset-0 rounded-full border-4 border-blue-400/40 transform rotate-12 animate-spin" style={{
                                    ...
                                    {/* Middle ring - 第二层：推理层 */}
                                    <div className="absolute inset-12 rounded-full border-4 border-purple-400/50 transform -rotate-6 animate-spin" style={{
                                    ...
                                    <div className="absolute inset-20 rounded-full border-4 border-cyan-400/60 transform rotate-3 animate-pulse" style={{
                                        ...
                                        <div className="w-full h-full rounded-full flex items-center justify-center transform -rotate-3">
                    ...
                    <div className="h-full flex flex-col justify-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-white/20">
                        ...
                        <div className="mb-8">
                            ...
                            <h2 className="text-4xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 bg-clip-text text-transparent mb-3 leading-tight">早期中华文明智能体平台</h2>
                            <div className="flex items-center space-x-3 mb-6">
                                <div className="w-2 h-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full animate-pulse"></div>
                                <p className="text-xl font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">ECC Agent</p>
                            </div>
                        </div>
                        
                        {/* Content sections */}
                        <div className="space-y-6 text-gray-700 leading-relaxed">
                            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-5 border-l-4 border-blue-400 shadow-sm">
                            ...
                            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl p-5 border-l-4 border-purple-400 shadow-sm">
                                <div className="flex items-start space-x-3">
                            ...
                            <div className="bg-gradient-to-r from-indigo-50 to-cyan-50 rounded-xl p-5 border-l-4 border-indigo-400 shadow-sm">
                                <div className="flex items-start space-x-3">
                ...
                <div className="max-w-5xl mx-auto px-4 relative z-10">
                    ...
                    <div className="text-center mb-16">
                        <div className="inline-block mb-6">
                            <span className="px-6 py-3 bg-gradient-to-r from-purple-100 to-pink-100 text-purple-800 rounded-full text-sm font-semibold shadow-lg">🤝 Academic Collaboration</span>
                        </div>
